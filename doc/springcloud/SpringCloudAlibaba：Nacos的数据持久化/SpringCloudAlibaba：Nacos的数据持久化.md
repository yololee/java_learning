...
-e MYSQL_SERVICE_HOST=192.168.31.100 
-e MYSQL_SERVICE_PORT=3306 
-e MYSQL_SERVICE_DB_NAME=nacos_config 
-e MYSQL_SERVICE_USER=root 
-e MYSQL_SERVICE_PASSWORD=root 
-v /huanglei/v-nacos/init.d/custom.properties:/home/nacos/init.d/custom.properties 
-v /huanglei/v-nacos/logs:/home/nacos/logs 
--restart=always 
--name=nacos nacos/nacos-server
```

> 使用`docker logs 容器名 ` 是下面这个样子就启动成功了 

![在这里插入图片描述](https://img-blog.csdnimg.cn/48b6821fdc614217b62130ef8be72442.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA5ouS57ud54as5aSc5ZWK,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/381070cb11d34e8aad350a71d273933a.png#pic_center)


#### 4.查看数据库

![在这里插入图片描述](https://img-blog.csdnimg.cn/fbc22dc60bba4de4b9f5b2b3282df164.png#pic_center)
